...
export default function Examples() {
  ...
  return (
    <Section title="Examples" id="examples">
      {/* На къстъм компонентите, пропертитата, като id в случая, не се предават автоматично */}
      {/* Можем да ползваме Forwarding Props със ...props вътре в компонента. Така TabButton може да приеме*/}
      {/* директно onClick, вместо onSelect */}
      <Tabs
